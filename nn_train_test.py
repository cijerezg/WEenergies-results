...
class nn_model:
    ...
    def train(self, data, epochs, lr, evaluate, save=False, path=None):
        """
        ...
        loader = DataLoader(dset, batch_size=1024, shuffle=True, num_workers=4)
        optimizer = optim.SGD(self.model.parameters(), lr = lr, momentum=0.1)
        train_loss = []
        self.model.train()
